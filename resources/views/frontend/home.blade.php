    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-item">
            <div class="carousel-container">
                <img src="{{asset('public/images/js0.jpg')}}">
        ...
        <div class="carousel-item active">
            <div class="carousel-container">
                <img src="{{asset('public/images/js1.jpg')}}"  >
{{--                <h2 class="animated fadeInDown">Welcome to <span>{{ config('app.name') }}</span></h2>--}}
{{--                <p class="animated fadeInUp">Online Model Medicine Shop (Home Delivery), Rangpur City.</p>--}}
{{--                <a href="" class="btn-get-started animated fadeInUp">সুস্থ জীবন </a>--}}
            </div>
        </div>
        ...
        <div class="carousel-item">
            <div class="carousel-container">
                <img src="{{asset('public/images/js2.jpg')}}" >
{{--                <h2 class="animated fadeInDown">Welcome to JS Pharmacy</h2>--}}
{{--                <p class="animated fadeInUp">Online Model Medicine Shop (Home Delivery), Rangpur City.</p>--}}
{{--                <a href="" class="btn-get-started animated fadeInUp">সুস্থ জীবন </a>--}}
            </div>
        ...
        <div class="carousel-item">
            <div class="carousel-container">
                <img src="{{asset('public/images/js3.jpg')}}"  >
{{--                <h2 class="animated fadeInDown">Welcome to JS Pharmacy</h2>--}}
{{--                <p class="animated fadeInUp">Online Model Medicine Shop (Home Delivery), Rangpur City.</p>--}}
{{--                <a href="" class="btn-get-started animated fadeInUp">সুস্থ জীবন </a>--}}
            </div>
