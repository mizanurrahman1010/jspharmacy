<aside class="main-sidebar elevation-4 sidebar-light-pink">
    ...
    <a href="{{route('home')}}" class="brand-link navbar-light">
        <img src="{{asset('public/dist/img/logo.jpg')}}" alt="AdminLTE Logo"
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                @if(Auth::user()->checkUserType()=='admin')
                    @include('dashboard.common.sidebar-admin')
                @elseif(Auth::user()->checkUserType()=='delivery_man')
                    @include('dashboard.common.sidebar-delivery_man')
                @else
                    @include('dashboard.common.sidebar-customer')
                @endif
