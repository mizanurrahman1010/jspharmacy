    ...
    <!-- /.content-header -->
        ...
        <section id="main-content" class="content">
                ...
                @if(sizeof($orderInfo)>0)
                    @if($orderInfo[0]->prescription_image!=null)

                        <div class="row justify-content-md-center">

                            <div class="card col-lg-10" >
                                <img class="card-img-top" src="{{asset('public/prescriptions/'.$orderInfo[0]->prescription_image)}}" alt="Card image cap">
                                <div class="card-body card-blue">
                                    <h5 class="card-title">Order Notes</h5>
                                    <p class="card-text">
                                        {{$orderInfo[0]->delivery_note}}
                                    </p>
                                </div>
                            </div>
                        </div>
