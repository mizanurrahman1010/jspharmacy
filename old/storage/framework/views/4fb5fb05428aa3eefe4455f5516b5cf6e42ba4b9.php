            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="javascript:void(0)" title="Edit" data-toggle="tooltip" data-id="<?php echo e($category->id); ?>"
                            data-original-title="Edit" class="edit btn bg-gradient-primary btn-xs editCategory"> <i
                                class="far fa-edit"></i></a>
                        <a href="javascript:void(0)" title="Delete" data-toggle="tooltip" data-id="<?php echo e($category->id); ?>"
...
<script type="text/javascript">
    $(function () {
        ...
        $('body').on('click', '.editCategory', function () {
            ...
            axios.get("<?php echo e(route('category.index')); ?>" + '/' + category_id + '/edit')
        ...
        $('#saveBtn').click(function (e) {
            ...
            let createUrl = "<?php echo e(route('category.store')); ?>";
            let updateUrl = "<?php echo e(route('category.update',0)); ?>";
        ...
        $('body').on('click', '.deleteCategory', function () {
            ...
            if (confirm("Are You sure want to delete !")) {
                $.ajax({
                    type: "DELETE",
                    url: "<?php echo e(route('category.store')); ?>" + '/' + category_id,
                    success: function (data, textStatus, xhr) {
                        // table.draw();
                        if (xhr.status == 200) {
                            location.reload();
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/jspharmacy/resources/views/dashboard/category/index.blade.php ENDPATH**/ ?>